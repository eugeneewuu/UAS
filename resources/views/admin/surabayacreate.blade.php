<x-template-layout>
    ...
    <div class="shadow px-6 py-4 bg-gray-200 rounded sm:px-1 sm:py-1">
        <form action="{{ isset($surabaya) ? route('surabaya.update', $surabaya->id) : route('surabaya.store') }}"
            method="POST">
            @csrf
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input value="{{ isset($surabaya) ? $surabaya->nama : old('nama') }}" type="text"
                                name="nama" id="company_website"
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input value="{{ isset($surabaya) ? $surabaya->nik : old('nik') }}" type="text" name="nik"
                                id="company_website"
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input value="{{ isset($surabaya) ? $surabaya->alamat : old('alamat') }}" type="text"
